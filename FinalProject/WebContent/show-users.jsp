							...
							<%
								...
								if (session.getAttribute("allUsers") != null) {
									...
									while (itr.hasNext()) {
										...
										out.print("<tr>");
										out.print("<td>" + userBean.getId() + "</td>");
										out.print("<td>" + userBean.getFirstname() + "</td>");
										out.print("<td>" + userBean.getLastname() + "</td>");
										out.print("<td>" + userBean.getMobile()+ "</td>");
										out.print("<td>" + userBean.getEmail() + "</td>");
										out.print("<td>" + userBean.getState() + "</td>");
										out.print("<td>" + userBean.getDistrict() + "</td>");
										out.print("<td>" + userBean.getSubdistrict() + "</td>");
										out.print("<td>" + userBean.getPin() + "</td>");
										out.print("<td>" + userBean.getCity() + "</td>");
										out.print("<td>" + userBean.getIsActive() + "</td>");
										out.print("<td>" + userBean.getCreated_by() + "</td>");
										out.print("<td>" + userBean.getCreated_date() + "</td>");
										out.print("<td>" + userBean.getModified_by() + "</td>");
										out.print("<td>" + userBean.getModified_date() + "</td>");
										out.print("</tr>");
									}
								}
							%>
