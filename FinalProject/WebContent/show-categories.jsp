	...
	public String user(HttpServletRequest req) {
		...
		<div class="main-container">
			<div class="header">
				<header>
				<div class="logo">
					<a href="admin-dashboard.jsp"><img title="Admin Portal"
						src="images/logo.png" width="200" height="60" alt="logo"></a>
				</div>
				<div class="srch-con">
				...
				<div>
					...
					<div class="category">
						<div class="pets">
							<select title="pet categories" name="category"
								onchange="validate.selectedCategory(this)">
								<option value="Shop By Category" selected>Shop By
									Category</option>
								...
								<option value="Mobile"
									onchange="validate.selectedCategory(this)">Mobiles</option>
							</select>
						</div>
						<div id="clear-both"></div>
					</div>
					...
					<div class="profiles">
						...
						<div id="profile-icon">
							...
							<div>
								<a onclick=<%=isLoggedIn(request, "favourite")%>
									title="favorites"> <img src="images/unliked.png"
									alt="favorite" />
								</a>
							</div>
							<div>
								<a onclick=<%=isLoggedIn(request, "dashboard")%>
									title="dashboard"> <img src="images/sell.png"
									alt="dashboard" />
								</a>
							</div>
						</div>
						...
						<table align="center" border="solid 1px" cellspacing="0" cellpadding="0">
							...
							<%
								...
								if (session.getAttribute("allCategories") != null) {
									ArrayList categories = (ArrayList) session.getAttribute("allCategories");
